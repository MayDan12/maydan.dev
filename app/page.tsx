      ...
      <div className="relative min-h-screen bg-background text-foreground overflow-hidden ">
        ...
        <header className="fixed top-0 left-0 right-0 z-40 bg-background/80 backdrop-blur-md border-b">
          <div className="container flex items-center justify-between h-16">
            ...
            >
              <span className="text-primary">Mayowa </span>Oluwanimotele
            </Link>
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center mt-14">
                ...
                >
                  ...
                  <p className="text-muted-foreground mb-6">
                    With over 4 years of experience as a Frontend/Full-Stack
                    Developer, I specialize in creating engaging digital
                    experiences using React, Next.js, TypeScript, and Tailwind
                    CSS. My approach combines technical expertise with creative
                    problem-solving to deliver applications that are both
                    functional and visually appealing. I have worked on projects
                    ranging from e-commerce platforms and educational technology
                    apps to real-time web and mobile applications, always with a
                    focus on performance, usability, and collaboration.
                  </p>
          ...
          <section className="py-10  bg-muted/30" id="projects">
            <div className="container ">
              ...
              <div className="mt-16 grid gap-12">
                <ProjectCard
                  title="Masjid Link"
                  description="Your all-in-one platform connecting Muslims with their local masjids and strengthening Ummah bonds"
                  tags={[
                    "Next.js",
                    "Framer Motion",
                    "Tailwind CSS",
                  ...
                  imageUrl="/masjidlink.png"
                  reverse={true}
                  link="https://masjidlink.vercel.app/"
                  sourcecode="/"
                />
                <ProjectCard
                ...
                <ProjectCard
                  ...
                  description="A property listing website that allows home-owners lists thier spaces to liable tenants."
                ...
                <ProjectCard
                  title="Parkkly"
                  description="We are a technology company first, but with a major focus on Safe, Smart, and Sustainable Parking Within Your Reach."
                  tags={["Next.js", "Firebase", "Framer Motion", "Tailwind"]}
                  imageUrl="/Parkkly.png"
                  reverse={false}
                  link="https://www.parkkly.com/"
                  sourcecode="/"
                />
                <ProjectCard
                  title="OmniFood"
                  ...
                  sourcecode="/https://github.com/MayDan12/Omni-Food"
                />
              </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <Link
                          href="mailto:oluwamayowadan@gmail.com"
                          className="font-medium"
                        >
                          oluwamayowadan@gmail.com
                        </Link>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <Link
                          href="https://github.com/MayDan12"
                          className="font-medium"
                        >
                          github.com/MayDan12
                        </Link>
...
function AnimatedText() {
  const words = ["inspire", "engage", "impress", "convert"];
